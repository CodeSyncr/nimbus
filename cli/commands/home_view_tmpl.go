...
// Server-rendered welcome page (resources/views/home.nimbus) for `nimbus new` web apps.
...
<section class="hero">
  <div class="hero-left">
    ...
    <h1 class="hero-title">
      Build fast.<br>
      Deploy with<br>
      <span class="accent">{{ .appName }}.</span>
    </h1>
    <p class="hero-sub">{{ if .tagline }}{{ .tagline }}{{ else }}A Laravel-inspired web framework for Go — expressive, elegant, and blazing fast. From scaffolding to production in minutes.{{ end }}</p>
    <div class="hero-ctas">
    ...
    <div class="cmd-block">
      ...
      <button class="cmd-copy" title="Copy command" onclick="navigator.clipboard.writeText('nimbus new my-app --kit=web'); this.classList.add('copied'); this.textContent='✓'; var b=this; setTimeout(function(){ b.classList.remove('copied'); b.textContent='⎘'; }, 1800);">⎘</button>
    </div>
  </div>
...
<div class="stats-row">
  ...
  <div class="stat">
    <div class="stat-val">Laravel</div>
...
<div class="features-grid">
  ...
  <div class="card fade-up">
    <div class="card-icon cyan">
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
    </div>
  ...
  <div class="card fade-up">
    <div class="card-icon rose">
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg>
    </div>
  ...
  <div class="card fade-up">
    <div class="card-icon green">
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>
    </div>
  ...
  <div class="card fade-up">
    <div class="card-icon sky">
      <svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14M4.93 4.93a10 10 0 0 0 0 14.14"/></svg>
    </div>
    <h3>Event System</h3>
...
<div class="code-section">
  <div class="section-divider" style="margin-bottom:20px">
