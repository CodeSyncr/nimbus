...
const inertiaPageHomeSvelte = `<script>
  ...
  function copyCommand(e) {
    navigator.clipboard.writeText('nimbus new my-app --kit=svelte')
  ...
  <section class="hero">
    <div class="hero-left">
      ...
      <div class="cmd-block">
        ...
        <span class="cmd-text">nimbus new my-app --kit=svelte</span>
        <button type="button" class="cmd-copy" title="Copy command" on:click={copyCommand}>⎘</button>
      </div>
    </div>
