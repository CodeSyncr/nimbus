...
func IsUnpoly(c *context.Context) bool {
...
func Context(c *context.Context) map[string]any {
...
// (X-Up-Fail-Context).
func FailContext(c *context.Context) map[string]any {
...
func SetTarget(c *context.Context, selector string) {
...
func RenderNothing(c *context.Context) {
...
func SetTitle(c *context.Context, title string) {
...
func EmitEvent(c *context.Context, eventType string, props map[string]any) {
...
func AcceptLayer(c *context.Context, value any) {
...
func DismissLayer(c *context.Context, value any) {
	b, _ := json.Marshal(value)
...
func ExpireCache(c *context.Context, pattern string) {
...
func EvictCache(c *context.Context, pattern string) {
...
func SetLocation(c *context.Context, url string) {
...
func SetMethod(c *context.Context, method string) {
